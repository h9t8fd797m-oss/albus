...
- Language B: two 2020 briefs agree on five themes and five objectives, with numbering independently checked in the matching guide. Both assessment tables explicitly give HL external 75% and oral 25%; the previous 80/20 values were incorrect and are corrected. This is the only component-data change.
