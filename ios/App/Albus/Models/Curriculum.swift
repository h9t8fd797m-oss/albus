...
extension CurriculumSubject {
    ...
    static let all: [CurriculumSubject] = [
        ...
        .init(
            ...
            notes: ["Maximum 1,800 words; only the first 1,800 are marked.", "One real organisation, and exactly one of change, creativity, ethics or sustainability as the lens.", "Three to five supporting documents must be attached.", "25 marks, common to SL and HL under the 2024 guide.", "Criterion structure NOT published, and the sources are three-way contradictory rather than merely thin: knowledge base 7.7 [OFFICIAL] says 25 marks; ibcourses.net says four criteria A-D at 5 marks each totalling 20; ibmastery.com says 25 marks but cites a 'Criterion G' worth 2, implying seven criteria. A total that cannot be agreed on is not a split worth guessing at.", "The official IB subject brief confirms the component (20 hours, 20% at HL) but carries no per-criterion marks, as subject briefs never do.", "The public ibo.org subject page still describes the pre-2024 structure (HL research project, SL written commentary) despite a 2026 'last updated' date — do not source from it."],
            source: "https://www.ibo.org/programmes/diploma-programme/curriculum/",
        ...
        .init(
            ...
            notes: ["Maximum 2,200 words; bibliography and referencing sit outside the count.", "Section 2 carries 15 of the 25 marks.", "Same requirements at SL and HL; only the weighting differs.", "Figures taken from the Albus IB knowledge base v1.0 (compiled August 2026), which paraphrases the official IB subject guides rather than reproducing them. Verify against the current guide before quoting marks to a student.", "Guide currency conflict, unresolved: this file follows the knowledge base (7.5), which states the 2017 guide 'applies through May 2027; the new guide is first assessed May 2028.' An official IB subject brief PDF (Nord Anglia mirror, IBO copyright 2015) instead states 'First assessments 2017-last assessments 2025' for the same guide. Not resolved either way -- a student on the wrong side of this date would have the wrong IA criteria. Check directly against a current guide before the 2026-27 school year if this has not been done."],
            source: "https://www.ibo.org/programmes/diploma-programme/curriculum/",
            retrievedAt: "2026-08-25"
        ),
        .init(
